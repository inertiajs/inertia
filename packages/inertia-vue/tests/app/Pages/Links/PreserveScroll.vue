<template>
  <div style="width: 200vw; height: 200vh; margin-top: 50vh">
    ...
    <div id="area2" scroll-region style="overflow: scroll; background-color: #00FF00; width: 100px; height: 100px;">
      <div style="padding: 200px;">Test</div>
    </div>
  </div>
</template>
...
export default {
  ...
  mounted() {
    ...
    document.getElementById('area1').addEventListener('scroll', () => this.handleScrollEvent())
    document.getElementById('area2').addEventListener('scroll', () => this.handleScrollEvent())
  },
  methods: {
    handleScrollEvent() {
