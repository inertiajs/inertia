...
import { HeadManagerOnUpdate } from '@inertiajs/inertia'
...
export async function createInertiaApp({ id, resolve, setup, title, page, render }: InertiaAppOptionsForSSR | InertiaAppOptionsForCSR): Promise<{ head: string[]; body: string } | void> {
