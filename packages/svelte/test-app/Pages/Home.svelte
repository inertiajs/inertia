...
<div>
  ...
  <a href={undefined} on:click={visitsMethod} class="visits-method">Manual basic visits</a>
  <a href={undefined} on:click={visitsReplace} class="visits-replace">Manual 'Replace' visits</a>

  <button use:inertia={{ href: '/redirect', method: 'post' }} class="links-redirect">Internal Redirect Link</button>
  <a href={undefined} on:click={redirect} class="visits-redirect">Manual Redirect visit</a>

  <button use:inertia={{ href: '/redirect-external', method: 'post' }} class="links-redirect-external"
    >External Redirect Link</button
  >
  <a href={undefined} on:click={redirectExternal} class="visits-redirect-external">Manual External Redirect visit</a>
</div>
