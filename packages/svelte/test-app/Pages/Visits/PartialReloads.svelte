...
<div>
  ...
  <a href={'#'} on:click|preventDefault={partialReloadVisitExceptFooBar} class="visit-except-foo-bar">'Except' foo + bar (visit)</a>
  ...
  <a href={'#'} on:click|preventDefault={partialReloadGetExceptFooBar} class="get-except-foo-bar">'Except' foo + bar (GET)</a>
