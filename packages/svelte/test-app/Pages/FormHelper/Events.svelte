...
<div>
  ...
  <button on:click|preventDefault={onCancelProcessing} class="cancel-processing">onCancel resets processing</button>
  <button on:click|preventDefault={onCancelProgress} class="cancel-progress">onCancel progress property</button>
