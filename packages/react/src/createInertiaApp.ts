...
import { createExternalRouterScope } from './externalRouterScope'
    ...
    .then(([initialComponent]) => {
      ...
      if (setup) {
        return (setup as (options: SetupOptions<HTMLElement, SharedProps>) => void)({
          ...
          App,
          props,
          dispose: externalRouterScope?.dispose,
        })
      }
      ...
      if (el.hasAttribute('data-server-rendered')) {
        const root = hydrateRoot(el, appElement)
