  ...
  (
    ...
    return createElement(
      'form',
      {
        ...
        // React 19 supports passing a boolean to the `inert` attribute.
        // For compatibility with earlier versions, we use the 'true'.
        // Unfortunately, React 19 does not support an empty string.
