...
export default () => {
  ...
  return (
    <div>
      ...
      <a href="#" onClick={exceptionVisitPreventLocal} className="exception-prevent-local">
        Exception Event (Prevent)
      </a>
      <a href="#" onClick={exceptionVisitPreventGlobalInertia} className="exception-prevent-global-inertia">
        Exception Event - Prevent globally using Inertia Event Listener
      </a>
      <a href="#" onClick={exceptionVisitPreventGlobalNative} className="exception-prevent-global-native">
        Exception Event - Prevent globally using Native Event Listeners
      </a>
