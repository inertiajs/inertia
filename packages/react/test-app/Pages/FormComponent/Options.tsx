import type { Method, StringArrayFormatOption } from '@inertiajs/core'
...
export default () => {
  ...
  const [queryStringArrayFormat, setQueryStringArrayFormat] = useState<StringArrayFormatOption | undefined>(undefined)
