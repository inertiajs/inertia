...
import { echo as resolveEcho, echoIsConfigured } from '@laravel/echo-vue'

export type { EchoOptions }

/** Delivers live prop updates over the Echo instance `configureEcho()` from `@laravel/echo-vue` set up. */
