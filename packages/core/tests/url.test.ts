...
import { mergeDataIntoQueryString } from './../src/url'

describe('url.ts', () => {
  describe('mergeDataIntoQueryString', () => {
    describe('GET request', () => {
      it('appends data to a URL without an existing query string', () => {
      ...
      it('merges new data into an existing query string', () => {
      ...
      it('overwrites existing keys in the query string when they also exist in the data', () => {
      ...
      it('removes query string keys when their corresponding data value is undefined', () => {
      ...
      it('serializes arrays using bracket notation by default', () => {
      ...
      it('serializes arrays using index notation when specified', () => {
      ...
      it('preserves the full origin when the URL is absolute', () => {
      ...
      it('maintains hash fragments when appending query parameters', () => {
      ...
      it('replaces previous array values completely when using index notation', () => {
      ...
      it('replaces nested objects without merging with existing keys', () => {
      ...
      it('retains indexed object keys in the query string during parsing and stringification', () => {
    ...
    describe('non-GET request', () => {
      it('leaves the href unchanged when data is present', () => {
      ...
      it('retains the original query string and returns data untouched', () => {
      ...
      it('preserves hash fragments in the href', () => {
      ...
      it('does not modify the query string even if data includes keys already present in the href', () => {
      ...
      it('handles absolute URLs without modifying the query string', () => {
