  ...
  <div class="rounded border border-gray-200 bg-gray-50 p-4">
    ...
    >
      ...
      <div class="flex gap-2">
        ...
        <button
          type="button"
          on:click={() => validate(['name', 'email', ...(validateFiles ? ['avatar'] : [])])}
  ...
  <div class="rounded border border-gray-200 bg-gray-50 p-4">
    ...
    >
      ...
      <div class="flex flex-wrap gap-2">
        <button type="button" on:click={() => validate()} class="rounded bg-blue-600 px-3 py-1.5 text-sm text-white">
          Validate
        </button>
        <button type="button" on:click={() => reset()} class="rounded bg-gray-600 px-3 py-1.5 text-sm text-white">
          Reset All
        </button>
        <button type="button" on:click={() => reset('name')} class="rounded bg-gray-600 px-3 py-1.5 text-sm text-white">
          Reset Name
        </button>
      </div>
