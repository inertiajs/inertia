...
<template>
    <Head title="InstantScroll2" />
    <h1 class="text-3xl">InstantScroll2</h1>
    <article class="max-w-3xl">
        ...
        <Link href="/instant-scroll/1" class="hover:underline text-white bg-slate-800 px-4 py-2 rounded-md">Page 1</Link>
        <p class="my-6">
